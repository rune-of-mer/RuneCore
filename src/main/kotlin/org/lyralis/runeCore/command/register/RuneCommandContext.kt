...
data class RuneCommandContext(
     ...
     * コマンドの実行者を返す．
     *
     * - [org.lyralis.runeCore.command.annotation.PlayerOnlyCommand] アノテーションを付与しない場合，この値は必ずしもプレイヤーとは限らず，コンソールを示す場合がある．
     ...
     * - [org.lyralis.runeCore.command.annotation.PlayerOnlyCommand] アノテーションを付与しない場合，この値は必ずしもプレイヤーとは限らず，コンソールを示す場合がある．
     *
     * @throws IllegalStateException [org.lyralis.runeCore.command.annotation.PlayerOnlyCommand] アノテーションを付与されたクラスでコンソールからの処理が行われた場合にスローされる．
     */
